...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color:#020228">
 ...
 <div class="container my-5" style="padding-bottom:300px;">
   <h3>TRAINER DETAILS</h3>
    <button class="btn btn-primary my-5"><a href="add_trainer.php" class="text-light">Add new Trainer</a></button>
    ...
    $result = mysqli_query($connection,$sql);
       if($result)
       {
           while( $row=mysqli_fetch_assoc($result))
           {
            ...
            <th>'.$age.'</th>
        <td>
        <button class="btn btn-primary"><a href="trainer_update.php?updateid='.$id.'" class="text-light">Update</a></button>
        <button class="btn btn-danger"><a href="trainer_delete.php?deleteid='.$id.'" class="text-light">Delete</a></button>
        </td>
      </tr>';
