...
if (isset($_POST['submit']))
{
    ...
    $shift = $_POST['rshift'];
    $id=$_GET['updateid'];
    $sql="update `shift` set id=$id,name='$name',shift='$shift' where id=$id";
     ...
     <div class="container my-5">
        ...
        <form autocomplete="off"  class="form-center" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" autocomplete="false" placeholder="Enter your name" name="rshift">
                            </div>
